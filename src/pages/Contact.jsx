    ...
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-10 justify-center text-sm mb-28'>
        ...
        <div className='flex flex-col gap-6 items-start'>
          ...
          <p className='font-semibold text-blue-800 font-serif text-lg'>CAREERS AT AL-SHIFA</p>
      ...
      <div className="max-w-4xl mx-auto px-5 py-10 bg-sky-300 rounded-md shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <textarea
            rows="5"
            name="message"
            placeholder="Message for AL-SHIFA Here..."
            value={form.message}
            onChange={handleChange}
