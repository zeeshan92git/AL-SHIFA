    ...
    <div>
      ...
      <div className="my-10 flex flex-col md:flex-row gap-12 px-4">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600 p-5">
          <p>Welcome to Al-SHIFA, your trusted partner in managing your healthcare needs conveniently and efficiently. At Al-SHIFA, we understand the challenges individuals face when it comes to scheduling doctor appointments and managing their health records.</p>
          <p>Al-SHIFA is committed to excellence in healthcare technology. We continuously strive to enhance our platform, integrating the latest advancements to improve user experience and deliver superior service. Whether you're booking your first appointment or managing ongoing care, Al-SHIFA is here to support you every step of the way.</p>
          <b className="text-blue-800 font-serif text-lg">Our Vision</b>
          <p>Our vision at Al-SHIFA is to create a seamless healthcare experience for every user. We aim to bridge the gap between patients and healthcare providers, making it easier for you to access the care you need, when you need it.</p>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row mb-20 text-sm md:ml-4 md:mr-4">
        <div className="border px-10 md:px-16 py-4 sm:py-16 flex flex-col gap-5 text-sm hover:bg-sky-500 hover:text-white text-gray-500 transition-all duration-300 cursor-pointer">
          <b>EFFICIENCY:</b>
      ...
      {/* FAQ's Section */}
      <div className="p-8 bg-sky-500 rounded-3xl shadow-2xl my-12">
        ...
        <div className="space-y-6">
          {faqData.map((faq, index) => (
            <div
              key={index}
              className="p-6 bg-blue-200 rounded-xl shadow-sm hover:shadow-md transition cursor-pointer"
