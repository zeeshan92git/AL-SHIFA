...
const Home = () => {
  ...
  return (
    <div>
      ...
      <div className="px-6 py-10 bg-gradient-to-r from-blue-200 via-sky-200 to-blue-200 rounded-3xl shadow-2xl my-12 mx-6 md:mx-16 lg:mx-28">
