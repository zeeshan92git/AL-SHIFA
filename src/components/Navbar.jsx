  ...
  return (
    <div className="flex items-center justify-between  gap-2 text-sm py-4 mb-5 border-b border-gray-400 px-6 md:px-10 lg:px-20 xl:px-28">
      ...
      <div onClick={() => navigate('/')} className="flex items-center gap-2 cursor-pointer">
        <img src="./logo.png" alt="logo" className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 object-contain" />
        <div className="text-base sm:text-xl md:text-3xl text-blue-900 font-bold font-serif">
          Al-SHIFA
        </div>
      </div>
